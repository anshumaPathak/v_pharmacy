      ...
      child: Column(
        children: [
          ...
          Column(
            children: [
              Text(
                '${AppLocalizations.of(context)!.whatsappNumber}: ${contact != null ? contact.whatsappNumber ?? '' : ' '}',
                style: const TextStyle(fontSize: 14, color: Color(0xff64748b)),
              ),

              const SizedBox(height: 4),
              Text(
                '${AppLocalizations.of(context)!.phoneNumber}: ${contact != null ? contact.alternateNumber.toString() : ''}',
                style: const TextStyle(fontSize: 14, color: Color(0xff64748b)),
              ),
              const SizedBox(height: 4),
              Text(
