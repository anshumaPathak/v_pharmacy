  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          TopBar(
            selectedIndex: _getSelectedIndex(), // TopBar highlight
                  ...
                  SizedBox(
                    ...
                    child: DashboardBody(
                      onSectionChange: (section) {
                        setState(() {
                          activeSection = section; // now parent will update
                        });
                      },
                    ),
                  ),
                        ...
                        final cards = [
                          CategoryCard(
                            ...
                            subtitle: AppLocalizations.of(
                              context,
                            )!.uploadPrescriptionAndOrderWithEase,
                            bgColor: Colors.lightBlue.shade50,
                            onTap: () =>
                                setState(() => activeSection = "services"),
                          ),
                          CategoryCard(
                            ...
                            subtitle: AppLocalizations.of(
                              context,
                            )!.realTimeTrackingWithWhatsAppAndCallUpdates,
                            bgColor: Colors.lightBlue.shade50,
                            onTap: () =>
                                setState(() => activeSection = "services"),
                          ),
                          CategoryCard(
                            ...
                            subtitle: AppLocalizations.of(
                              context,
                            )!.checkAuthenticityVerificationSystem,
                            bgColor: Colors.lightBlue.shade50,
                            onTap: () =>
                                setState(() => activeSection = "services"),
                          ),
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            AppLocalizations.of(
                              context,
                            )!.joinThousandsOfSatisfiedCustomersWhoTrustMediCareForTheirHealthcareNeeds,
                            style: const TextStyle(
                              fontSize: 18,
                              color: Colors.black54,
                            ),
