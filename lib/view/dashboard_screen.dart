...
import '../utils/url_tracking_helper.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _changeSection(String section, {String? subSection}) {
    ...
    if (kIsWeb) {
      UrlTrackingHelper.trackPageViewBoth(
        pagePath: path,
        customParams: {
          'section': section,
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      // Track initial page view with URL parameters
      if (kIsWeb) {
        ...
        UrlTrackingHelper.trackPageViewBoth(
          ...
          customParams: {
            ...
            if (activeSubSection != null) 'subSection': activeSubSection!,
          },
        );
      }
    });
