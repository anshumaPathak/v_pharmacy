...
class _DashboardBodyState extends State<DashboardBody> {
  Color bgColor = AppColor.lightBlueColor;
  ...
  Widget build(BuildContext context) {
      ...
      children: [
        ...
        DashboardTextSection(
          ...
          onOrderMedicineTap: () {
            ...
            widget.onSectionChange?.call("services");
          },
          onLearnMoreTap: () {
            setState(() {
              bgColor = AppColor.lightBlueColor;
            });
            widget.onSectionChange?.call("about");
          },
        ),
    ...
    //           widget.onSectionChange!("services");
    //       },
    //       onLearnMoreTap: () {
    //         if (widget.onSectionChange != null)
    //           widget.onSectionChange!("about");
    //       },
    //     ),
    //     DashboardImageSection(isMobile: isMobile),
    //   ],
